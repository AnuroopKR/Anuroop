...
const SocialLink = () => {
  return (
    <div className="flex items-center gap-6 text-4xl mt-6 mx-1 ">
      <Link href="www.linkedin.com/in/anuroopkr" target="_blank">
      ...
      <Link href="https://github.com/AnuroopKR" target="_blank">
        <FaGithub className="bg-white text-gray-800 hover:text-black transition-transform duration-300 hover:scale-110 rounded-md" />
      </Link>
      <Link href="https://www.instagram.com/anu_boyskottur?igsh=a2FkOGtyNnZjaTZy" target="_blank">
