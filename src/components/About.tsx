    ...
    <section className="bg-white py-16 px-6 md:px-12">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-1/2">
          <p className="text-yellow-500 font-semibold uppercase mb-2">About Me</p>
          <h2 className="text-4xl font-extrabold text-gray-900 mb-6 leading-tight">
            Self-Taught Developer Turning Ideas Into Real Products
          </h2>

          <p className="text-gray-600 mb-4">
            I am a self-taught Full Stack Developer with expertise in front-end and back-end technologies. 
            My journey into tech began from scratch, and I am now passionate about building clean, scalable 
        ...
        <div className="md:w-1/2">
          <Image
            src="/hero2.png" // Replace with your image path or external URL
