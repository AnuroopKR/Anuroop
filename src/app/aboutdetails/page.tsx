      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mb-4">
              I began my coding journey with no formal background, fueled purely
              by curiosity and determination. Through consistent self-learning,
              building real-world projects, and solving problems, I transitioned
              from a beginner to a confident full-stack developer.
            </p>
            <p>
              I believe in continuous growth and always strive to stay updated
              with new technologies and best practices in the development world.
            </p>
          </div>
        ...
        <div>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Clean Code:</strong> I value writing readable and
              maintainable code that scales well.
            </li>
            <li>
              <strong>User Experience:</strong> I strive to build products that
              are intuitive and enjoyable to use.
            </li>
            <li>
              <strong>Problem Solving:</strong> I love challenges and am
              passionate about solving real-world problems with code.
            </li>
            <li>
              <strong>Learning &amp; Sharing:</strong> Whether it&rsquo;s
              through blogs or helping others, knowledge grows when shared.
            </li>
          </ul>
        </div>
        ...
        <div className="text-center mt-10">
          ...
          <p className="text-gray-600 mb-4">
            Feel free to reach out &mdash; I&apos;m always open to new
